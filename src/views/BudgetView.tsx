...
export const BudgetView: React.FC = () => {
  ...
  // Touch gestures for pinch-to-zoom (X and Y independently zoomable)
  useEffect(() => {
          ...
          >
            ...
            >
              ...
              >
                ...
                >
              <defs>
                {/* Clipping Path to keep elements bounded within the drawing area */}
              ...
              <g className="grid-lines">
                {/* Max Line */}
                <line x1={MARGIN_LEFT} y1={getY(effectiveMax)} x2={viewBoxWidth - MARGIN_RIGHT} y2={getY(effectiveMax)} stroke="var(--theme-glass-border)" strokeWidth="1" strokeDasharray="4 4" className="opacity-60" />
                <text x={MARGIN_LEFT - 10} y={getY(effectiveMax) + 4} fill="currentColor" fontSize="10" textAnchor="end" className="text-text-secondary font-medium opacity-80">{Math.round(effectiveMax).toLocaleString('de-DE')} €</text>

                {/* Middle Line */}
                <line x1={MARGIN_LEFT} y1={getY(effectiveMax / 2)} x2={viewBoxWidth - MARGIN_RIGHT} y2={getY(effectiveMax / 2)} stroke="var(--theme-glass-border)" strokeWidth="1" strokeDasharray="4 4" className="opacity-60" />
                <text x={MARGIN_LEFT - 10} y={getY(effectiveMax / 2) + 4} fill="currentColor" fontSize="10" textAnchor="end" className="text-text-secondary font-medium opacity-80">{Math.round(effectiveMax / 2).toLocaleString('de-DE')} €</text>

                {/* Origin Line (0 Euro) */}
                <line x1={MARGIN_LEFT} y1={getY(0)} x2={viewBoxWidth - MARGIN_RIGHT} y2={getY(0)} stroke="var(--theme-glass-border)" strokeWidth="1.5" />
